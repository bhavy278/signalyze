...
//             ${isDragging
//               ? 'border-blue-600 bg-blue-600/10'
//               : 'border-gray-200 bg-light-100 hover:border-gray-300 hover:bg-light-0'
//             }
//           `}
//         >
//           <div className="flex flex-col items-center justify-center text-gray-500">
//             <UploadCloud size={48} className={`mb-4 transition-colors ${isDragging ? 'text-blue-600' : 'text-gray-400'}`} />
//             <p className="font-semibold text-gray-700">
...
//         </div>
//       ) : (
//         <div className="bg-light-100 p-4 rounded-xl border border-gray-200 flex items-center justify-between transition-all duration-300 animate-in fade-in">
//           <div className="flex items-center gap-4">
//             <File size={32} className="text-blue-600 flex-shrink-0" />
//             <div>
//               <p className="font-semibold text-dark truncate max-w-xs">{file.name}</p>
//               <p className="text-sm text-gray-500">{formatFileSize(file.size)}</p>
//             </div>
//           </div>
//           <button
//             onClick={handleRemoveFile}
//             className="p-1.5 rounded-full text-gray-500 hover:bg-gray-100 hover:text-dark transition-colors"
//             aria-label="Remove file"
//           >
//             <X size={20} />
//           </button>
